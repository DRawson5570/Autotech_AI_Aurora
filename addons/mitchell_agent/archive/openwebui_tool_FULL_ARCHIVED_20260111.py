...
class Tools:
    ...
    async def query_autonomous(
        ...
        """
        AI-powered automotive query using autonomous navigation.
        
        This tool uses local AI (llama3.1:8b) to intelligently navigate ShopKeyPro
        and find the answer to any automotive question.
        
        Examples:
        - "What is DTC P0455?"
        - "What is the engine oil capacity?"
        - "Show me the starting charging wiring diagram"
        - "What is connector X310?"
        
        IMPORTANT: Use this for complex queries. The AI will figure out 
        the best navigation path automatically.
        """
        return await self._make_request(
            "query_autonomous",
            year, make, model, engine,
